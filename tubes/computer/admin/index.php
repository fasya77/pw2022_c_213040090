...
<body>
	...
	<body>
		<!-- kalo mau akses halaman admin, harus login -->
		<?php
		if (empty($cekuserlogin)) {
					...
					<div class="row">
						...
						<div class="col-10">
							<div class="header_menu">
								...
								<a href="?page=tambah_kategori" class="menu_atas">Kategori Produk</a>
								<a href="?page=tambah_produk" class="menu_atas">Produk</a>
			...
			<div class="konten">
				<?php
				// di halaman admin, include semua yg ada di bawah ini
				$page = mysqli_real_escape_string($conn, @$_GET['page']);
				if ($page == "tambah_produk") {
